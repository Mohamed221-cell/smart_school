...
<html>
 ...
 <body>
    ...
    <div id="header">
      ...
      <div id="contents">
    	<div id = "sec_stu"><br/><br><br>
                    <center>
                        <a href= "InsertTeacher.php"><button  id="sec_btn" type="button" class="btn btn-danger">Register Teacher</button></a><br><br><br>
                        <a href= "SearchTeacher2.php"><button id="sec_btn" type="button" class="btn btn-danger">Search teacher</button>
                    </a><br><br>
                        <a href= "Edit_Teacher.html"><button id="sec_btn" type="button" class="btn btn-danger">Edit  teacher</button>
                    </a><br><br>
                    </center>
                </div>
    </div>    
